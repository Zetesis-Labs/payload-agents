...
logger = structlog.get_logger("agno_microsoft_teams.verification")

OPENID_CONFIG_URL = "https://login.botframework.com/v1/.well-known/openidconfiguration"
ALLOWED_ISSUERS = ("https://api.botframework.com",)
...
def _build_claims(*, claims: dict[str, Any], body_service_url: str | None) -> VerifiedClaims | None:
