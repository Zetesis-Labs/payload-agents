...
logger = structlog.get_logger("agno_agent_builder.channels.teams.interface")


def build_msal_client(*, app_id: str, app_password: str, tenant_id: str | None) -> msal.ConfidentialClientApplication:
...
class TeamsInterface:
    ...
    def get_router(self) -> APIRouter:
        router = APIRouter(prefix=self._prefix, tags=["Teams"])
